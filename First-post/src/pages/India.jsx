...
import { fetchIndiaData } from '../Reducer/action'
import { useNavigate } from 'react-router-dom'
import { Slider } from '../components/Slider'

export const India = () => {
    const data = useSelector((store)=>store.NewsData.IndiaNews)
 ...
 <div style={{marginTop:'10%'}}>
    ...
    <div className={styles.ArticlesContainer}>
        <div className={styles.HeadLine}>
            ...
            <div><label>India News</label></div>
        </div>
        <div className={styles.RolexContanier}>
            <div>
                <h1 style={{fontSize:"30px",fontWeight:"bold"}}>INDIA NEWS</h1>
