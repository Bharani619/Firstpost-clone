...
import { fetchSportsData } from '../Reducer/action'
import { useNavigate } from 'react-router-dom'
import { Slider } from '../components/Slider'


export const Sports = () => {
    const data = useSelector((store)=>store.NewsData.SportsData)
 ...
 <div style={{marginTop:'10%'}}>
    ...
    <div className={styles.ArticlesContainer}>
        <div className={styles.HeadLine}>
            ...
            <div><label>Sports News</label></div>
        </div>
        <div className={styles.RolexContanier}>
            <div>
                <h1 style={{fontSize:"30px",fontWeight:"bold"}}>SPORTS NEWS</h1>
