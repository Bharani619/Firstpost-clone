...
import { fetchCricketData } from '../Reducer/action'
import { useNavigate } from 'react-router-dom'
import { Slider } from '../components/Slider'

export const Cricket = () => {
    const data = useSelector((store)=>store.NewsData.Cricket)
 ...
 <div style={{marginTop:'10%'}}>
    ...
    <div className={styles.ArticlesContainer}>
        <div className={styles.HeadLine}>
            ...
            <div><label>Cricket News</label></div>
        </div>
        <div className={styles.RolexContanier}>
            <div>
                <h1 style={{fontSize:"30px",fontWeight:"bold"}}>CRICKET NEWS</h1>
