...
import { fetchPoliticsData } from '../Reducer/action'
import { useNavigate } from 'react-router-dom'
import { Slider } from '../components/Slider'

export const Politics = () => {
    const data = useSelector((store)=>store.NewsData.Politics)
 ...
 <div style={{marginTop:'10%'}}>
    ...
    <div className={styles.ArticlesContainer}>
        <div className={styles.HeadLine}>
            ...
            <div><label>Politics News</label></div>
        </div>
        <div className={styles.RolexContanier}>
            <div>
                <h1 style={{fontSize:"30px",fontWeight:"bold"}}>POLITICS NEWS</h1>
