...
import { fetchTechData } from '../Reducer/action'
import { useNavigate } from 'react-router-dom'
import { Slider } from '../components/Slider'

export const Tech = () => {
    const data = useSelector((store)=>store.NewsData.Tech)
 ...
 <div style={{marginTop:'10%'}}>
    ...
    <div className={styles.ArticlesContainer}>
        <div className={styles.HeadLine}>
            ...
            <div><label>Technology News</label></div>
        </div>
        <div className={styles.RolexContanier}>
            <div>
                <h1 style={{fontSize:"30px",fontWeight:"bold"}}>TECHNOLOGY NEWS</h1>
