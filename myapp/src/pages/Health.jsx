...
import { fetchHealthData } from '../Reducer/action'
import { useNavigate } from 'react-router-dom'
import { Slider } from '../components/Slider'

export const Health = () => {
    const data = useSelector((store)=>store.NewsData.HealthData)
 ...
 <div style={{marginTop:'10%'}}>
    ...
    <div className={styles.HeadLine}>
            ...
            <div><label>Health News</label></div>
        </div>
        <div className={styles.RolexContanier}>
            <div>
                <h1 style={{fontSize:"30px",fontWeight:"bold"}}>HEALTH NEWS</h1>
